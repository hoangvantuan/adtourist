    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav nav-center">
        ...
        <li class="dropdown dropdown-parrent">
          <a href="index.php?controller=tour&amp;lang=<?php echo $lang  ?>" class="dropdown-toggle disabled" data-toggle="dropdown" role="button" aria-expanded="false"><?php echo $lang =='en' ? 'Tourist' : 'Du lịch giá tốt' ?></a>
        ...
        <!-- Du lich Xe-->
        <li class="dropdown dropdown-parrent">
          <a href="index.php?controller=service_car" ><?php echo $lang =='en' ? 'Car Rental' : 'Dịch vụ Xe' ?></a>
      <ul class="dropdown-menu dropdown-menu-parrent" role="menu">
        <?php if(isset($area)){?>
          <?php 
        ...
        <!-- Ve may bay -->
        <li class="dropdown dropdown-parrent">
          <a href="index.php?controller=ticket_plane&amp;lang=<?php echo $lang  ?>" class="dropdown-toggle disabled" data-toggle="dropdown" role="button" aria-expanded="false"><?php echo $lang =='en' ? ' Air ticket' : 'Vé máy bay' ?></a>
          <ul class="dropdown-menu dropdown-menu-parrent" role="menu">
